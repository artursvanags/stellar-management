...
const statusBadge = {
  new: {
    label: 'New',
    color:
      'bg-emerald-400 text-emerald-900 dark:bg-emerald-950 dark:text-emerald-500',
  },
  used: {
    label: 'Used',
    color:
      'bg-yellow-400 text-yellow-900 dark:bg-yellow-950 dark:text-yellow-500',
  },
  archived: {
    label: 'Archived',
    color:
  ...
  in_use: {
    label: 'In Use',
    color:
      'bg-orange-400 text-orange-900 dark:bg-orange-950 dark:text-orange-500',
  },
};
