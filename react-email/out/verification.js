...
var import_html = __toESM(require_dist());
var import_button = __toESM(require_dist2());
function Email(props) {
  const { url } = props;
  return <import_html.Html lang="en"><import_button.Button href={url}>Click me</import_button.Button></import_html.Html>;
}
var verification_default = Email;
